//varible
const audioList = [
    new Audio("herta_kuru-main/audio/kuruto.mp3"),
    new Audio("herta_kuru-main/audio/kuru1.mp3"),
    new Audio("herta_kuru-main/audio/kuru2.mp3"),
];
...
function animateHerta() {
    ...
    elem.src = `herta_kuru-main/img/hertaa${random}.gif`;
